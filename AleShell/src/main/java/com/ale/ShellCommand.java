...
public class ShellCommand {
    ...
    public void du() {
    	PrintLog2("1. 查看当前目录下所有的文件和目录使用磁盘空间的总大小.");
    	PrintLog4("du -hs");
    	PrintLog6();
    ...
    public void free() {
    	PrintLog2("1. 查看内存信息(以mebibytes为单位-M).");
    	PrintLog4("free -m");
    	PrintLog6();
    ...
    public void ln() {
    	PrintStarLog2("1.在当前目录下创建目录的链接,目标目录:/opt/ac    链接名:ac");
    ...
    public void cp() {
    	PrintStarLog2("1. 将1.txt文件复制到ma目录下.");
    ...
    public void echoa() {
		PrintLog2("1. 将输出的屏幕信息重定向生成一个新文件.");
    ...
    public void tar() {
    	PrintStarLog2("1. 压缩ac目录,扩展名以tar.gz结尾.");
    ...
    public void gzip() {
    	PrintStarLog2("1. 压缩文件，扩展名以.gz结尾.");
    ...
    @ShellMethod(value = "压缩/解压文件或目录",group="压缩")
    public void zip() {
    	PrintStarLog2("1. 压缩目录，扩展名以.zip结尾.");
    ...
    public void rmdir() {
    	PrintStarLog2("1. 删除当前目录下的ab目录(ab目录里必须为空).");
    ...
    public void chmod() {
		PrintStarLog2("1. 将ac目录权限变为:文件所有者读写执、用户组读执行、其它用户读.");
    ...
    public void chown() {
    	PrintStarLog2("1. 改变ac目录的所有者为www、用户组为root");
    ...
    public void chgrp() {
    	PrintStarLog2("1. 改变ac目录的用户组为www");
    ...
    public void ping() {
    	PrintLog2("1. 检测主机是否能通(请把abc.abc.com改成您想测试的域名).");
    ...
    public void nc() {
		PrintLog2("1. 传输文件,将源服务器的目录aa(及其子目录和文件)传输到目的服务器中.");
  ...
  //-------------------------------------------------------- 执行shell ----------------------------------------------------------------------
    ...
    public void exec(String str) {
    	...
    	simpleShellCommand.execShellCmd(str, "UTF-8");
    }
    ...
    public void PrintLog4(String str) {
    	System.out.println("  --"+str);
    }

    public void PrintLog5(String str) {
    	System.out.println("    ##"+str);
    }
    public void PrintLog6() {
    	System.out.println("");
    }


    public void PrintStarLog2(String str) {
    	System.out.println("  "+str);
    }
    public void PrintStarLog4(String str) {
    	System.out.println("  **"+str);
    }
    ...
    public void copyright() {    	
		PrintLog("    	 Copyright 2022 the original author.");
